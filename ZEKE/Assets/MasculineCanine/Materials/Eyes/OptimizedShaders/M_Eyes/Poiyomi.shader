Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon/8d35b1b2ff121c74b9cc3c2bb9ffddf2"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyFlipbook(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				poiFragData.baseColor = lerp(poiFragData.baseColor, flipBookPixel.rgb, flipBookPixel.a * float4(1,1,1,1).a * _FlipbookReplace * flipBookMask * flipbookAlpha);
